...
const recipeSchema = {
  ...
  properties: {
    title: {type:'string'},
    emoji: {type:'string'},
    meal_type: {type:'string', enum:['breakfast','lunch','tea']},
